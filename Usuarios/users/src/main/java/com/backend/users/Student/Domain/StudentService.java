...
public class StudentService {
    ...
    public StudentService(StudentRepository studentRepository, AuthService authService, PasswordEncoder passwordEncoder, SalonRepository salonRepository) {
    ...
    public DTOStudentProfile getStudentProfile(RequestDTO dto) {
        Optional<Student> st = studentRepository.findByEmail(dto.getEmail());
        if (st.isEmpty()) {
            throw new RuntimeException("El estudiante no existe");
        }
